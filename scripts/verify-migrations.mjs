...
await withDisposablePostgres(async ({ env, bin, port, databaseName }) => {
  ...
  run(
    ...
    [
      ...
      'ON_ERROR_STOP=1',
      '-c',
      "DO $$ BEGIN IF (SELECT count(*) FROM suppliers WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 20 OR (SELECT count(*) FROM factories WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 50 OR (SELECT count(*) FROM products WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 30 OR (SELECT count(*) FROM materials WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 20 OR (SELECT count(*) FROM routes WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 15 OR (SELECT count(DISTINCT port_id) FROM route_ports WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 10 OR (SELECT count(*) FROM source_articles WHERE source_id='a1000000-0000-4000-8000-000000000001') <> 100 OR (SELECT count(*) FROM news_radar_exposures WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 100 OR (SELECT count(*) FROM daily_brief_items WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') <> 20 THEN RAISE EXCEPTION 'POC demo seed counts are invalid'; END IF; END $$; SELECT (SELECT count(*) FROM customers) AS customers, (SELECT count(*) FROM suppliers WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') AS demo_suppliers, (SELECT count(*) FROM factories WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') AS demo_factories, (SELECT count(*) FROM source_articles WHERE source_id='a1000000-0000-4000-8000-000000000001') AS demo_articles, (SELECT count(*) FROM news_radar_exposures WHERE customer_id='5a6ce6b4-0d65-4d16-90dc-04b751f5169b') AS demo_exposures, (SELECT count(*) FROM sources WHERE collection_enabled) AS collection_enabled_sources, to_regclass('public.daily_briefs') IS NOT NULL AS briefs_available;",
    ],
    { env },
  );
});
