...
export class SupplyChainService {
  ...
  async graph(customerId: string) {
    const [customer, companies, countries, locations, suppliers, factories, products, materials, routes, companySuppliers, factoryLocations, supplierProducts, factoryProducts, productMaterials, routeSuppliers, routeFactories, routePorts] = await db.$transaction([
