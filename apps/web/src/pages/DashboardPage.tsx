import { ArrowDown, Clock3, DatabaseZap } from 'lucide-react';
...
export function DashboardPage() {
  return (
    <div className="p-5 sm:p-8">
      ...
      <div className="mt-4"><EmptyState title="Intelligence pipeline not configured" description="Phase 1 establishes the secure application foundation. Sources, events, scoring, and exposure matching will be implemented in later approved phases." /></div>
